...
client.user.setGame(`| type: ABhelp |`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message => {
   if(message.content.startsWith(prefix + 'help')) {
        ...
        .setTitle(`**تم ارسال الاوامر في الخاص**`)
...
client.on("message", message => {
 if (message.content === "ABhelp") {
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
『 ABplay ➾ لتشغيل أغنية برآبط أو بأسم』
『 ABskip ➾ لتجآوز الأغنية الحآلية』
『 $pa ➾ إيقآف الأغنية مؤقتا』
『 $re ➾ لموآصلة الإغنية بعد إيقآفهآ مؤقتا』
『 $vol ➾ لتغيير درجة الصوت 10 - 0』
